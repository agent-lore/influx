...
- `docs/SPECIFICATION.md` for the current implemented behavior and source of truth.
...
When output names a domain concept in an issue title, refactor proposal, hypothesis, test name, or implementation plan, use the terms from `CONTEXT.md` when it exists. If a concept is not documented there, prefer the terms already used in `docs/SPECIFICATION.md` and the codebase.
